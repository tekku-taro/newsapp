        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#"><span>フォルダ名</span></a></li>
                ...
                <div class="col-md-4">
                    ...
                    <p class="text-right clipping-date">2020/04/21 保存</p>
                </div>
            </div>
            <h4><i class="fas fa-folder" style="color: rgb(52,143,249);"></i>&nbsp;フォルダ名</h4>
            <div class="row">
                <div class="col-sm-8">
                    <h2>記事の題名</h2>
                </div>
